...
export default function ViewOrder() {
  return (
    <div className="flex">
      ...
      <div className="view-order bg-white p-6 rounded-lg shadow-md flex-1 mx-4 my-4">
        <h2 className="text-3xl font-bold mb-4 text-blue-700">Welcome to Order Management</h2>
