...
export default function EventManagerLogin() {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left Side Image */}
      <div className="hidden md:flex flex-1 items-center justify-center bg-cover bg-center" style={{ backgroundImage: "url('/images/image.png')" }}>
        {/* You can add additional content or styles for this side if needed */}
      </div>
