    ...
    <div className="bg-gray-100 min-h-screen flex flex-col justify-between">
      ...
      <div className="relative">
        ...
        <div
          ...
          style={{
            backgroundImage: 'url(/images/windsurfback.jpg)', // Replace with the actual image URL
          }}
        >
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center text-white px-4">
            ...
            <p className="text-center max-w-xl text-lg mb-7">
              Windsurfing is an exciting water sport that blends surfing and sailing. It involves standing on a board
              with an attached sail, using the wind to move across the water. The sport requires 
              balance, agility, and skill to control both the board and sail, making it popular in windy coastal
              areas and lakes.
            </p>
